//Config code for Gaynamed Flight Computer
//Copy paste into _initalize_hardware (overwrite everything allready there)
//You also need to go to system->src->stm32f4-hal and include the following
//(to include files right click on file->properties->C/C++ Build uncheck "exclude from resource")
//stm32f4xx_hal_adc.c
//stm32f4xx_hal_spi.c
